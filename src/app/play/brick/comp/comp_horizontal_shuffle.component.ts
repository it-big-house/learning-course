...
@Component({
    ...
    template: `
    <div class="horizontal-shuffle-container no-select" [dragula]="'DRAG'" [(dragulaModel)]="userChoices" fxLayout.gt-xs="row wrap" fxLayout.xs="row wrap" fxLayoutAlign.xs="center center">
