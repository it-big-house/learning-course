...
@Component({
    ...
    <div class="arrow-container" fxFlex="1 1 100%" fxLayout="row">
        ...
        <mat-list [dragula]="'DRAG1'" [(dragulaModel)]="userCats[1].choices" class="arrow-list">
            <mat-list-item style="cursor: pointer;" class="arrow-text-right no-select touch-list-item" *ngFor="let item of userCats[1].choices; let ind = index" fxLayout="row" fxLayoutAlign="space-around center">
